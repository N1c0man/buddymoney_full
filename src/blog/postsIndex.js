...
export const posts = [
  {
    ...
    heroImageAlt: "Owl saving for his first 1000 dollars",
...

  {
    ...
    heroImageAlt:
      "A secured credit card with a small lock symbol representing credit building",
...

  {
    ...
    readTime: "8 min read",
    excerpt:
      "Common budgeting mistakes that silently drain your money — and simple fixes for each.",
    ...
    heroImageAlt:
      "Person stepping over financial traps labeled bills, spending, debt",
